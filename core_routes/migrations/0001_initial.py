# Generated by Django 4.1.7 on 2023-06-21 21:09
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateField(default=datetime.date.today, validators=[django.core.validators.MaxValueValidator(limit_value=datetime.date(2023, 6, 21), message='Date can not be later than today')])),
                ('date_received', models.DateField(validators=[django.core.validators.MaxValueValidator(limit_value=datetime.date(2023, 6, 21), message='Date can not be later than today')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_modification', models.DateField(default=datetime.date.today, validators=[django.core.validators.MaxValueValidator(limit_value=datetime.date(2023, 6, 21), message='Date can not be later than today')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created_on', models.DateField(default=datetime.date.today, validators=[django.core.validators.MaxValueValidator(limit_value=datetime.date(2023, 6, 21), message='Date can not be later than today')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('WAITING_INVOICE', 'Waiting Invoice'), ('WAITING_DELIVERY', 'Waiting Delivery'), ('WAITING_AVOIR', 'Waiting Avoir'), ('AVOIR_RECEIVED_WAITING_INVOICE', 'Avoir Received Waiting Invoice'), ('CLOSED', 'Closed')], max_length=100)),
                ('date_created', models.DateField(default=datetime.date.today, validators=[django.core.validators.MaxValueValidator(limit_value=datetime.date(2023, 6, 21), message='Date can not be later than today')])),
                ('month', models.CharField(max_length=100)),
                ('commande_number', models.CharField(max_length=6, unique=True)),
                ('expected_delivery_date', models.DateField(default=None, validators=[django.core.validators.MaxValueValidator(limit_value=datetime.date(2023, 6, 21), message='Date can not be later than today')])),
